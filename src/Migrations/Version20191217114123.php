 ...
 */
final class Version20191217114123 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX unique_match_player_id ON match_player (smite_match_id, god_id)');
    }
